...
export const Route = createRootRoute({
  ...
  head: () => ({
    ...
    links: [
      ...
      { rel: "alternate", type: "text/markdown", href: abs("/llms-full.txt"), title: "Full reference (markdown)" },
      ...
      { rel: "icon", type: "image/x-icon", href: "/favicon.ico", sizes: "16x16 24x24 32x32 48x48 64x64" },
...
const navLink =
  "rounded-full px-2.5 py-1 text-sm font-medium whitespace-nowrap text-white/80 transition-colors hover:text-white sm:px-3 [&.active]:bg-white/10 [&.active]:text-white"
  ...
  return (
    <html lang="en" className="dark">
      ...
      >
        ...
        <nav className="fixed top-4 left-1/2 z-50 flex max-w-[calc(100vw-1rem)] -translate-x-1/2 items-center gap-0.5 rounded-full border border-white/10 bg-black/40 p-1.5 text-white backdrop-blur-md sm:gap-1 sm:top-6">
          ...
          <a
            ...
            className="inline-flex items-center gap-2 rounded-full px-2.5 py-1 text-sm font-medium text-white/80 transition-colors hover:bg-white/10 hover:text-white sm:px-3"
