...
export function CopyForAi({
  ...
  return (
    <button
      ...
      className={cn(
        "inline-flex min-h-11 shrink-0 items-center gap-1.5 rounded-lg bg-input/30 px-2 text-[11px] font-medium text-muted-foreground transition-colors hover:bg-input/50 hover:text-foreground focus-visible:ring-2 focus-visible:ring-ring/50 focus-visible:outline-none",
        className
      )}
    >
      {state === "copied" ? (
